# [API-026] POST /api/v1/responses/{responseId}/likes
...
- 본인의 답변에도 좋아요를 누를 수 있으며, 동일 회고방 멤버 간의 긍정적인 피드백을 유도합니다.
...
| RETRO4031 | 403 | 회고방 멤버가 아닌 유저가 좋아요 시도 | 요청 사용자가 해당 회고가 속한 회고방의 멤버가 아닌 경우 |
