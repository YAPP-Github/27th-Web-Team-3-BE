...
| 1.2.0 | 2026-01-25 | 에러 코드 RETRO4031로 통일 |
...
```json
{
  "isSuccess": false,
  "code": "RETRO4031",
  "message": "해당 회고가 속한 회고방의 멤버가 아닙니다.",
  "result": null
}
```
...
| RETRO4031 | 403 | 회고방 멤버가 아님 | JWT의 유저가 해당 회고가 속한 회고방의 멤버가 아닌 경우 |
