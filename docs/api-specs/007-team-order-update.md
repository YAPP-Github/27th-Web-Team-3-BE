...
| retroRoomOrders[].retroRoomId | long | Yes | 순서를 변경할 팀 고유 ID | - |
...
| TEAM4031 | 403 | 참여하지 않은 팀의 ID 포함 | 요청자가 멤버로 참여하지 않은 팀의 retroRoomId를 포함하여 요청 |
| TEAM4041 | 404 | DB에 존재하지 않는 retroRoomId | 존재하지 않거나 삭제된 팀의 retroRoomId를 포함하여 요청 |
