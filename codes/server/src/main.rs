...
use crate::domain::retrospect::dto::{
    ...
    GuideItem, GuideType, InviteCodeResponse, JoinRetroRoomRequest, JoinRetroRoomResponse,
    LeaveRetroRoomResponse, LikeToggleResponse, ListCommentsQuery, ListCommentsResponse,
    ...
    RetrospectListStatus, RetrospectMemberItem, RetrospectQuestionItem, SearchRetrospectItem,
    ...
    SuccessEmptyResponse, SuccessInviteCodeResponse, SuccessJoinRetroRoomResponse,
    SuccessLeaveRetroRoomResponse, SuccessLikeToggleResponse, SuccessListCommentsResponse,
...
#[openapi(
    paths(
        ...
        domain::retrospect::handler::get_invite_code,
    ...
    components(
        schemas(
            ...
            LeaveRetroRoomResponse,
            SuccessLeaveRetroRoomResponse,
            RetrospectListItem,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route(
            "/api/v1/retro-rooms/:retro_room_id/invite-code",
            axum::routing::get(domain::retrospect::handler::get_invite_code),
        )
        .route(
